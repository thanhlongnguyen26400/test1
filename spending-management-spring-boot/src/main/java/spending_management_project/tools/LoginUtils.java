...
import spending_management_project.enums.GrantType;
import spending_management_project.exception.IllegalTokenTypeException;

import javax.servlet.http.HttpServletRequest;
import java.util.HashMap;
import java.util.Map;

import static spending_management_project.constant.AuthorityConstant.BASIC;
