...
public class ErrorMsgHelper {
  ...
  public static String getReturnMsg(ErrorType errorType, String param1) {
    return param1 != null ? String.format(errorType.description(), param1) : errorType.description();
  }
}
